...
$toemails[] = array(
				'email' => 'ncic5354@sbcglobal.com', // Your Email Address
				'name' => 'Robert Medina' // Your Name
			);
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	if( $_POST['template-contactform-email'] != '' ) {
		...
		if( $botcheck == '' ) {
			...
			$ar_body = "Thank you for contacting us. We will reply within 24 hours.<br><br>Regards,<br>Northern California Institute of Cosmetology New.";
